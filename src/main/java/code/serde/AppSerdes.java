...
import code.types.HadoopRecord;
import code.types.Notification;
import code.types.PosInvoice;
...
public class AppSerdes extends Serdes {
    ...
    public static final class PosInvoiceSerde extends Serdes.WrapperSerde<PosInvoice> {
        PosInvoiceSerde() {
    ...
    public static final class NotificationSerde extends Serdes.WrapperSerde<Notification> {
        NotificationSerde() {
            super(new JsonSerializer<>(), new JsonDeserializer<>());
        }
    }
